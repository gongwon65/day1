...
data220102 = act[ (act['timestamp'] >= '2022-01-02 00:00:00.000') & (act['timestamp'] < '2022-01-03 00:00:00.000') ].copy()
...
dbDevice.child('2022-01-02').set( updates )
